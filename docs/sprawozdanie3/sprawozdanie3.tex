...
12: 1,5,11}}
	...
	Wyjściem programu jest odpowiedź na pytanie czy zadany graf jest planarny. 
	Jeżeli nie jest, dodatkowo wyświetlany jest na konsoli podgraf ściągalny do $K_5$ lub $K_{3,3}$ przy pomocą takiej samej reprezentacji jak graf wejściowy.
