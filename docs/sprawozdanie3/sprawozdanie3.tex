...
\maketitle
	...
	\pagebreak
	\todo[inline]{Chwilowo tylko draft, bo szukam kompa z windowsem :P}
	\todo[inline]{3cia w nocy - ciężko się piszę... zaznaczam draft, siąde porządnie jutro wieczorem :)}

	\section{Wynikowa implementacja}
	...
	\subsection{Dokumnetacja kodu źródłowego}

		Wygenerowaną dokumentację doxygen \todo[inline]{albo dowolną inną? tam jest jakieś /// w VStudio?} znaleźć można w repozytorium z kodem źródłowym w katalogu doc.
